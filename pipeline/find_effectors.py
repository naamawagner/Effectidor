...
def parse_blast_out(blast_out, e_val=10**(-10), min_identity=0.7, min_coverage=50):
    blast_out_dic = {}
...
homologs = list(parse_blast_out('blast_outputs/effectorsDB.blast', min_identity=k, min_coverage=min_coverage).values())
for h in homologs:
